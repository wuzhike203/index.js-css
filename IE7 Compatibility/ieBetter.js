...
function IE(){
    ...
    if(navigator.appName == "Microsoft Internet Explorer"){
        res = navigator.appVersion.match(/\d[.]/i);
    }else{
        res = false;
    }
    return (res && res instanceof Array && res.length>0) ?
           res[0] : false 
}
...
function ie7(){
    /*
     * 判断是否为IE7-
     * 结果存入全局变量window.wuji.ie7 中
     * */
    var res = IE();
    window.wuji.ie7 = (res && parseInt(res) <= 7) ? true : false; 
}

function ie8(){
    /*
     * 判断是否为IE8
     * 结果存入全局变量window.wuji.ie8 中
     * */
    var res = IE();
    window.wuji.ie8 = (res && parseInt(res) == 8) ? true : false; 
}
...
(function(window, document, undefined) {
	...
	*/
	var oDomExtend = {
        ...
        hasOwnProperty: function(attr_name){
    ...
    for(var i in oDomExtend){
        // document
        if( !document[i] ){
            document[i] = function(i){
                return function(arg){
                    return (i in document) ? document[i] : oDomExtend[i].call(document, arg);
                };
            }(i);
        }
        ...
        window[i] = function(i){
            return function(elem, arg){
                return (i in elem) ? elem[i] : oDomExtend[i].call(elem, arg);
            };
        }(i);
    }
    ...
    if(wuji.ie8){
        ...
        Element.prototype.hasOwnProperty = function(attr_name){
            return oDomExtend.hasOwnProperty.call(this, attr_name);
        };
    }
