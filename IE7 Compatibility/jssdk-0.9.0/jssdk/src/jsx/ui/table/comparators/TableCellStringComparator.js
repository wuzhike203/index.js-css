...
class TableCellStringComparator
{

	TableCellStringComparator(aColumn, aReversal, aInsensitiveComparator)
	{
		this.compare = function(aObjectA, aObjectB)
		{
			...
			return StringComparatorUtil.compare(a, b, aReversal, aInsensitiveComparator);
		}
	}
